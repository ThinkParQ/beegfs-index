...
#define BEEGFS_OPS_ERR_SUCCESS                0
#define BEEGFS_OPS_ERR_INTERRUPTED            2
#define BEEGFS_OPS_ERR_COMMUNICATION          3
#define BEEGFS_OPS_ERR_COMMTIMEDOUT           4
#define BEEGFS_OPS_ERR_UNKNOWNNODE            5
#define BEEGFS_OPS_ERR_DYNAMICATTRIBSOUTDATED 10
#define BEEGFS_OPS_ERR_WOULDBLOCK             16
#define BEEGFS_OPS_ERR_AGAIN                  22
#define BEEGFS_OPS_ERR_STORAGE_SRV_CRASHED    23
#define BEEGFS_OPS_ERR_OUTOFMEM               26
#define BEEGFS_OPS_ERR_METAVERSIONMISMATCH    31
#define BEEGFS_OPS_ERR_INODELOCKED            32
